function [e_opt, u,EXITFLAG_zFixed, OUTPUT_zFixed] = minimization_energy_u_and_zFixed_testing(u,z,x,elems2nodes,dphi_3Dmatrix,F1inv,F2inv,areas,nodes,p)
...
function e=energy_vector_argument_free(vector)
    ...
    e = energy_u_and_z_testing(u_testing,z,x,elems2nodes,dphi_3Dmatrix,F1inv,F2inv,areas);
