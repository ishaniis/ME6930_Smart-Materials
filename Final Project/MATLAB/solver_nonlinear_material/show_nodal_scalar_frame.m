function show_nodal_scalar_frame(nodalValue,nodes2coord,elems2nodes,nodalDisplacement)
switch nargin, 
    case 3,
...
fill3(X(elems2nodes)',Y(elems2nodes)',nodalValue(elems2nodes)',nodalValue(elems2nodes)','FaceColor','interp');
